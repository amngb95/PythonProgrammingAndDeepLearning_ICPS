...
plt.title('Ground Truth : {}'.format(y_test[0:5]))
plt.show()

predict_test = model.predict_classes(X_test[[0], :])
print("The prediction of the 0th in the test dataset is: ", predict_test)

predict_test = model.predict_classes(X_test[[1], :])
print("The prediction of the 0th in the test dataset is: ", predict_test)

predict_test = model.predict_classes(X_test[[2], :])
print("The prediction of the 0th in the test dataset is: ", predict_test)
